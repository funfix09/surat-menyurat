                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('surat-masuk.update', $mail->id) }}">Edit</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <form action="{{ route('surat-masuk.update', $mail->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        @method('PATCH')
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="letter_number" class="form-control" required placeholder="Masukan Nomor Surat" value="{{ $mail->referance_number }}" autofocus>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    <label>Tanggal Nomor Surat <i class="text-danger">*</i></label>
                                                    <input type="date" name="date_letter_number" class="form-control" value="{{ $mail->date_letter_number }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    <label>Nomor Asal Surat <i class="text-danger">*</i></label>
                                                    <input type="text" name="origin_number" class="form-control" required placeholder="Masukan Nomor Asal Surat" value="{{ $mail->origin_number }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    <label>Tanggal Nomor Asal Surat <i class="text-danger">*</i></label>
                                                    <input type="date" name="date_origin_number" class="form-control" required value="{{ $mail->date_of_origin }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    <label>Pengirim <i class="text-danger">*</i></label>
                                                    <input type="text" name="sender" class="form-control" required placeholder="Masukan Pengirim Surat" value="{{ $mail->sender_mail }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <select name="is_urgent" class="form-select" required>
                                                        ...
                                                        <option value="0" {{ $mail->is_urgent == 0 ? 'selected' : ''  }}>Umum</option>
                                                        <option value="1" {{ $mail->is_urgent == 1 ? 'selected' : ''  }}>Penting</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                    ...
                                                    <select name="purpose[]" class="choices form-select multiple-remove" multiple="multiple" required>
                                                        @foreach ($divisions as $division)
                                                            <option value="{{ $division->id }}"
                                                                @foreach ($mail->dataDivision as $divisionMail)
                                                                    @if ($divisionMail->division_id === $division->id)
                                                                        selected
                                                                    @endif
                                                                @endforeach
                                                                >
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    id="floatingTextarea" rows="4">{{ $mail->regarding }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 fs-6">
                                                    ...
                                                    <small>*Upload untuk merubah perubahan</small><br>
